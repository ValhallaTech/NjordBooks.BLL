        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Greeting = table.Column<string>(maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentType = table.Column<string>(maxLength: 40, nullable: false),
                    FileData = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailTo = table.Column<string>(maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    HouseholdId = table.Column<int>(nullable: false),
                    NjordBooksUserId = table.Column<string>(maxLength: 40, nullable: true),
                    Name = table.Column<string>(maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankAccount_AspNetUsers_NjordBooksUserId",
                        column: x => x.NjordBooksUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Created = table.Column<DateTimeOffset>(nullable: false),
                    Type = table.Column<int>(nullable: false),
                    Memo = table.Column<string>(maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transaction_AspNetUsers_NjordBooksUserId",
                        column: x => x.NjordBooksUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccount_NjordBooksUserId",
                table: "BankAccount",
                column: "NjordBooksUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_NjordBooksUserId",
                table: "Transaction",
                column: "NjordBooksUserId");
        }
